...
@Repository
public class ItemAssignedToOthersOperatorRepository {

    @PersistenceContext
    private EntityManager entityManager;

    public ItemPage findItemsAssignedToOther(String userId, Map<Long, Set<RequestTaskType>> scopedRequestTaskTypes, Long page, Long pageSize) {

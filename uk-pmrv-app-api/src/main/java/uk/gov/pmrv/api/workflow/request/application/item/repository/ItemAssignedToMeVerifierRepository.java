...
@Repository
public class ItemAssignedToMeVerifierRepository {
    ...
    public ItemPage findItemsAssignedTo(String userId, Map<Long, Set<RequestTaskType>> scopedRequestTaskTypes, Long page, Long pageSize) {
        ...
        scopedRequestTaskTypes.forEach((vbId, types) ->
            hasPermissionOnTask
                .or(request.verificationBodyId.eq(vbId).and(requestTask.type.in(types)))
    ...
    public ItemPage findItemsAssignedToByAccount(String userId, Long accountId, Map<Long, Set<RequestTaskType>> scopedRequestTaskTypes,
        ...
        scopedRequestTaskTypes.forEach((vbId, types) ->
            hasPermissionOnTask
                .or(request.verificationBodyId.eq(vbId)

...
public interface AuthorityRepository extends JpaRepository<Authority, Long>, AuthorityCustomRepository {
    ...
    @Transactional(readOnly = true)
    @EntityGraph(value = "authority-permissions-graph", type = EntityGraph.EntityGraphType.FETCH)
    Optional<Authority> findByUserIdAndCompetentAuthority(String regulatorUserId, CompetentAuthority ca);
    ...
    @Transactional(readOnly = true)
    boolean existsByUserIdAndCompetentAuthority(String userId, CompetentAuthority competentAuthority);
    ...
    @Transactional(readOnly = true)
    List<Authority> findByCompetentAuthority(CompetentAuthority competentAuthority);

    @Transactional(readOnly = true)
    List<Authority> findByCompetentAuthorityAndStatusNot(CompetentAuthority competentAuthority, AuthorityStatus status);
    ...
    List<Authority> findByCompetentAuthorityAndPmrvSuperUserRolePermissions(CompetentAuthority competentAuthority);

...
@Component
public class ApplicationReviewCreatedHandler extends WorkflowDynamicExpirableUserTaskCreatedHandler {

    public ApplicationReviewCreatedHandler(final RequestTaskCreateService requestTaskCreateService) {
        super(requestTaskCreateService);
    }

    @Override
    public DynamicUserTaskDefinitionKey getTaskDefinition() {
        return DynamicUserTaskDefinitionKey.APPLICATION_REVIEW;
    }

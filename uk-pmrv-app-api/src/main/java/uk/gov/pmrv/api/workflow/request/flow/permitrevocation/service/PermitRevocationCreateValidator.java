...
@Service
public class PermitRevocationCreateValidator extends RequestCreateAbstractValidator {

    public PermitRevocationCreateValidator(final AccountQueryService accountQueryService,

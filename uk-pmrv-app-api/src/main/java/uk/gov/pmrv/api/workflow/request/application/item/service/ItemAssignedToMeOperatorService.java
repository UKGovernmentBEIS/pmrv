...
public class ItemAssignedToMeOperatorService implements ItemAssignedToMeService {
    ...
    private final ItemAssignedToMeOperatorRepository itemAssignedToMeOperatorRepository;
    ...
    public ItemDTOResponse getItemsAssignedToMe(PmrvUser pmrvUser, Long page, Long pageSize) {
        ...
        ItemPage itemPage = itemAssignedToMeOperatorRepository.findItemsAssignedTo(
            pmrvUser.getUserId(),
    ...
    /** {@inheritDoc} */
    @Override
    public ItemDTOResponse getItemsAssignedToMeByAccount(PmrvUser pmrvUser, Long accountId,

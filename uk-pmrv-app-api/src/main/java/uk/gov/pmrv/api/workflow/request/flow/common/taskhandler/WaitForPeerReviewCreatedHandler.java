...
@Component
public class WaitForPeerReviewCreatedHandler extends WorkflowDynamicExpirableUserTaskCreatedHandler {

    public WaitForPeerReviewCreatedHandler(RequestTaskCreateService requestTaskCreateService) {
        super(requestTaskCreateService);
    }

    @Override
    public DynamicUserTaskDefinitionKey getTaskDefinition() {
        return DynamicUserTaskDefinitionKey.WAIT_FOR_PEER_REVIEW;
    }

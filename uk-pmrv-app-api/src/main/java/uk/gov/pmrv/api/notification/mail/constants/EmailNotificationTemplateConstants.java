...
public final class EmailNotificationTemplateConstants {
    ...
    public static final String ACCOUNT_LEGAL_ENTITY_NAME = "legalEntityName";
    public static final String ACCOUNT_NAME = "installationAccountName";
    ...
    public static final String COMPETENT_AUTHORITY_PHONE = "competentAuthorityPhone";
    ...
    public static final String OFFICIAL_PMRV_CONTACT = "officialPmrvContact";

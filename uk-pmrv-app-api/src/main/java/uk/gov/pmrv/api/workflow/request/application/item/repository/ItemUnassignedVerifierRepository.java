...
@Repository
public class ItemUnassignedVerifierRepository {

    @PersistenceContext
    private EntityManager entityManager;

    public ItemPage findUnassignedItems(String userId, Map<Long, Set<RequestTaskType>> scopedRequestTaskTypes, Long page, Long pageSize) {
        ...
        JPAQuery<Item> jpaQuery = query.select(
                ...
                .where(requestTask.assignee.isNull().and(hasPermissionOnTask))
    ...
    public ItemPage findUnassignedItemsByAccount(String userId, Map<Long, Set<RequestTaskType>> scopedRequestTaskTypes,

...
describe('TemporaryFactorComponent', () => {
  ...
  it('should update values on setValue', () => {
    ...
    hostComponent.form.get('notification.details').setValue(notification.details);
    hostComponent.form.get('notification.proof').setValue(notification.proof);
    hostComponent.form.get('notification.measures').setValue(notification.measures);
    fixture.detectChanges();
  ...
  it('should apply field validations', () => {
    ...
    expect(endDate.errors).toEqual({ required: 'Enter the date non-compliance expected to end' });
    ...
    hostComponent.form.get('notification.details').setValue('a'.repeat(10001));
    fixture.detectChanges();
    expect(details.errors).toEqual({
      maxlength: 'Enter up to 10000 characters',
    });
    ...
    hostComponent.form.get('notification.proof').setValue('a'.repeat(10001));
    fixture.detectChanges();
    expect(proof.errors).toEqual({
      maxlength: 'Enter up to 10000 characters',
    });
    ...
    hostComponent.form.get('notification.measures').setValue('a'.repeat(10001));
    fixture.detectChanges();
    expect(measures.errors).toEqual({
      maxlength: 'Enter up to 10000 characters',
    });

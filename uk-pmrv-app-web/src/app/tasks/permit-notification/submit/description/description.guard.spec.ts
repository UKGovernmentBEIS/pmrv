...
import { DescriptionGuard } from './description.guard';

describe('DescriptionGuard', () => {
  let router: Router;
  let guard: DescriptionGuard;
  let permitNotificationService: PermitNotificationService;

  const activatedRouteSnapshot = new ActivatedRouteSnapshot();
  activatedRouteSnapshot.url = [new UrlSegment('description', null)];
  ...
  beforeEach(() => {
    ...
    guard = TestBed.inject(DescriptionGuard);
  ...
  it('should redirect to details-of-change if wizard hasnt started', async () => {

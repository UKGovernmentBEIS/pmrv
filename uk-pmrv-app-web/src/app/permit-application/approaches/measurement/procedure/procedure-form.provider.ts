...
import { MeasMonitoringApproach, ProcedureForm } from 'pmrv-api';
...
export const procedureFormProvider = {
  ...
  useFactory: (fb: FormBuilder, store: PermitApplicationStore, route: ActivatedRoute) => {
    ...
    const value = (state.permit.monitoringApproaches?.MEASUREMENT as MeasMonitoringApproach)[taskKey] as ProcedureForm;

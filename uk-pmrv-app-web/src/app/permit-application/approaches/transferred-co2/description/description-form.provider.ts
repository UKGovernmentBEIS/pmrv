  ...
  useFactory: (fb: FormBuilder, store: PermitApplicationStore) => {
    ...
    return fb.group({
      approachDescription: [
        ...
        [
          GovukValidators.required('Enter the approach description used to determine transferred CO2'),
          GovukValidators.maxLength(
            30000,
            'The approach description used to determine transferred CO2 should not be more than 30000 characters',
          ),
        ],
      ],
    });

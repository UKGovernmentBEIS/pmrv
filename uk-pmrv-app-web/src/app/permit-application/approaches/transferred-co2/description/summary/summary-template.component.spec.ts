...
describe('SummaryTemplateComponent', () => {
  ...
  it('should display the description', () => {
    const approach = mockPermitApplyPayload.permit.monitoringApproaches
      .TRANSFERRED_CO2 as TransferredCO2MonitoringApproach;

    expect(page.summaryListValues).toEqual([['Approach description', approach.approachDescription]]);
  });
});

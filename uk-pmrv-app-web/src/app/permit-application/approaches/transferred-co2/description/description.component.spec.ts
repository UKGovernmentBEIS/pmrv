...
describe('DescriptionComponent', () => {
  ...
  const route = new ActivatedRouteStub(
    {},
    {},
    { taskKey: 'monitoringApproaches.TRANSFERRED_CO2', statusKey: 'transferredCo2Description' },
  );
  ...
  describe('for new installation description', () => {
    beforeEach(() => {
      ...
      store.setState(mockStateBuild({ monitoringApproaches: { TRANSFERRED_CO2: { approachDescription: undefined } } }));
    });
    ...
    it('should submit a valid form, update the store and navigate to summary', () => {
      ...
      expect(page.errorSummaryErrorList).toEqual(['Enter the approach description used to determine transferred CO2']);
      ...
      expect(tasksService.processRequestTaskActionUsingPOST).toHaveBeenCalledWith(
        mockPostBuild(
          ...
          { ...mockPermitApplyPayload.permitSectionsCompleted, transferredCo2Description: [true] },
        ),
      );
  ...
  describe('for existing approach description', () => {
    ...
    it('should fill the form from the store', () => {
      expect(page.description).toEqual(
        store.getState().permit.monitoringApproaches.TRANSFERRED_CO2['approachDescription'],
      );
    });
    ...
    it('should submit a valid form, update the store and navigate to summary', () => {
      ...
      expect(page.errorSummary.querySelectorAll('a')[0].textContent.trim()).toEqual(
        'Enter the approach description used to determine transferred CO2',
      );
      ...
      expect(tasksService.processRequestTaskActionUsingPOST).toHaveBeenCalledWith(
        mockPostBuild(
          ...
          },
          {
            ...
            transferredCo2Description: [true],
          },
        ),
      );

...
describe('DescriptionComponent', () => {
  ...
  const route = new ActivatedRouteStub(
    {},
    {},
    { taskKey: 'monitoringApproaches.CALCULATION', statusKey: 'calculationDescription' },
  );
      ...
      store.setState(
        mockStateBuild({
          monitoringApproaches: {
            CALCULATION: { approachDescription: undefined, type: 'CALCULATION' },
          },
        }),
      );
    });
  ...
  describe('for existing calculation approach description', () => {
    ...
    it('should fill the form from the store', () => {
      expect(page.approachDescription).toEqual(
        store.getState().permit.monitoringApproaches.CALCULATION['approachDescription'],
      );
    });

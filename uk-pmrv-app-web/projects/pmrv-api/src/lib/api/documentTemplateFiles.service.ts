...
export class DocumentTemplateFilesService {
   ...
   */
  public generateGetDocumentTemplateFileTokenUsingGET(id: number, fileUuid: string): Observable<FileToken>;
  public generateGetDocumentTemplateFileTokenUsingGET(
    id: number,
    fileUuid: string,
    observe: 'response',
  ...
  public generateGetDocumentTemplateFileTokenUsingGET(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling generateGetDocumentTemplateFileTokenUsingGET.',
      );
    }
    if (fileUuid === null || fileUuid === undefined) {
      throw new Error(
        'Required parameter fileUuid was null or undefined when calling generateGetDocumentTemplateFileTokenUsingGET.',
      );
    }
    ...
    return this.httpClient.get<FileToken>(
      `${this.configuration.basePath}/api/v1.0/document-template-files/${encodeURIComponent(String(id))}`,
      {

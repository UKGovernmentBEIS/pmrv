...
export class VerifierUsersRegistrationService {
   ...
   */
  public acceptAndEnableVerifierInvitedUserUsingPUT(invitedUserEnableDTO?: InvitedUserEnableDTO): Observable<any>;
  public acceptAndEnableVerifierInvitedUserUsingPUT(
  ...
  public acceptAndEnableVerifierInvitedUserUsingPUT(
    ...
    return this.httpClient.put<any>(
      `${this.configuration.basePath}/api/v1.0/verifier-users/registration/enable-from-invitation`,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public acceptVerifierInvitationUsingPOST(tokenDTO?: TokenDTO): Observable<InvitedUserInfoDTO>;
  public acceptVerifierInvitationUsingPOST(
    tokenDTO: TokenDTO,
    observe: 'response',
    reportProgress?: boolean,
  ...
  public acceptVerifierInvitationUsingPOST(
    ...
    return this.httpClient.post<InvitedUserInfoDTO>(
      `${this.configuration.basePath}/api/v1.0/verifier-users/registration/accept-invitation`,
      tokenDTO,
      {
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,

...
export class UserSignaturesService {
   ...
   */
  public getSignatureUsingGET(token: string): Observable<Resource>;
  public getSignatureUsingGET(
    token: string,
    observe: 'response',
  ...
  public getSignatureUsingGET(
    ...
    if (token === null || token === undefined) {
      throw new Error('Required parameter token was null or undefined when calling getSignatureUsingGET.');
    }
    ...
    return this.httpClient.get<Resource>(
      `${this.configuration.basePath}/api/v1.0/user-signatures/${encodeURIComponent(String(token))}`,
      {

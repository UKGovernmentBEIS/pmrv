...
export class UsersService {
   ...
   */
  public editUserTermsUsingPATCH(updateTermsDTO?: UpdateTermsDTO): Observable<UpdateTermsDTO>;
  public editUserTermsUsingPATCH(
  ...
  public editUserTermsUsingPATCH(
    ...
    return this.httpClient.patch<UpdateTermsDTO>(
      `${this.configuration.basePath}/api/v1.0/users/terms-and-conditions`,
      updateTermsDTO,
      {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public generateGetCurrentUserSignatureTokenUsingGET(signatureUuid: string): Observable<FileToken>;
  public generateGetCurrentUserSignatureTokenUsingGET(
  ...
  public generateGetCurrentUserSignatureTokenUsingGET(
    ...
    if (signatureUuid === null || signatureUuid === undefined) {
      throw new Error(
        'Required parameter signatureUuid was null or undefined when calling generateGetCurrentUserSignatureTokenUsingGET.',
      );
    }
    ...
    return this.httpClient.get<FileToken>(`${this.configuration.basePath}/api/v1.0/users/signature`, {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getCurrentUserUsingGET(): Observable<ApplicationUserDTO>;
  ...
  public getCurrentUserUsingGET(
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*' },
  ): Observable<HttpEvent<ApplicationUserDTO>>;
  public getCurrentUserUsingGET(
    observe: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*' },
  ...
  public getCurrentUserUsingGET(
    ...
    return this.httpClient.get<ApplicationUserDTO>(`${this.configuration.basePath}/api/v1.0/users`, {
      responseType: <any>responseType_,
      withCredentials: this.configuration.withCredentials,
      headers: headers,
      observe: observe,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public provideUserFeedbackUsingPOST(userFeedbackDto?: UserFeedbackDto): Observable<any>;
  public provideUserFeedbackUsingPOST(
  ...
  public provideUserFeedbackUsingPOST(
    ...
    return this.httpClient.post<any>(`${this.configuration.basePath}/api/v1.0/users/feedback`, userFeedbackDto, {
      responseType: <any>responseType_,
      withCredentials: this.configuration.withCredentials,
      headers: headers,
      observe: observe,

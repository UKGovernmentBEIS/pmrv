...
export class FileDocumentsService {
   ...
   */
  public getFileDocumentUsingGET(token: string): Observable<Resource>;
  public getFileDocumentUsingGET(
    token: string,
    observe: 'response',
  ...
  public getFileDocumentUsingGET(
    ...
    if (token === null || token === undefined) {
      throw new Error('Required parameter token was null or undefined when calling getFileDocumentUsingGET.');
    }
    ...
    return this.httpClient.get<Resource>(
      `${this.configuration.basePath}/api/v1.0/file-documents/${encodeURIComponent(String(token))}`,
      {

...
export class NotificationTemplatesService {
   ...
   */
  public getCurrentUserNotificationTemplatesUsingGET(
    role: 'OPERATOR' | 'REGULATOR' | 'VERIFIER',
    page: number,
    size: number,
    term?: string,
  ...
  public getCurrentUserNotificationTemplatesUsingGET(
    ...
    if (role === null || role === undefined) {
      throw new Error(
        'Required parameter role was null or undefined when calling getCurrentUserNotificationTemplatesUsingGET.',
      );
    }
    if (page === null || page === undefined) {
      throw new Error(
        'Required parameter page was null or undefined when calling getCurrentUserNotificationTemplatesUsingGET.',
      );
    }
    if (size === null || size === undefined) {
      throw new Error(
        'Required parameter size was null or undefined when calling getCurrentUserNotificationTemplatesUsingGET.',
      );
    }
    ...
    return this.httpClient.get<TemplateSearchResults>(
      `${this.configuration.basePath}/api/v1.0/notification-templates`,
      {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getNotificationTemplateByIdUsingGET(id: number): Observable<NotificationTemplateDTO>;
  public getNotificationTemplateByIdUsingGET(
    id: number,
    observe: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*' },
  ...
  public getNotificationTemplateByIdUsingGET(
    ...
    if (id === null || id === undefined) {
      throw new Error('Required parameter id was null or undefined when calling getNotificationTemplateByIdUsingGET.');
    }
    ...
    return this.httpClient.get<NotificationTemplateDTO>(
      `${this.configuration.basePath}/api/v1.0/notification-templates/${encodeURIComponent(String(id))}`,
      {
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public updateNotificationTemplateUsingPUT(
    id: number,
  ...
  public updateNotificationTemplateUsingPUT(
    ...
    if (id === null || id === undefined) {
      throw new Error('Required parameter id was null or undefined when calling updateNotificationTemplateUsingPUT.');
    }

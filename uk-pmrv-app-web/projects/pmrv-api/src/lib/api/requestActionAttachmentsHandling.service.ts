...
export class RequestActionAttachmentsHandlingService {
   ...
   */
  public generateRequestActionGetFileAttachmentTokenUsingGET(id: number, attachmentUuid: string): Observable<FileToken>;
  public generateRequestActionGetFileAttachmentTokenUsingGET(
    id: number,
  ...
  public generateRequestActionGetFileAttachmentTokenUsingGET(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling generateRequestActionGetFileAttachmentTokenUsingGET.',
      );
    }
    if (attachmentUuid === null || attachmentUuid === undefined) {
      throw new Error(
        'Required parameter attachmentUuid was null or undefined when calling generateRequestActionGetFileAttachmentTokenUsingGET.',
      );
    }
    ...
    return this.httpClient.get<FileToken>(
      `${this.configuration.basePath}/api/v1.0/request-action-attachments/${encodeURIComponent(String(id))}`,
      {

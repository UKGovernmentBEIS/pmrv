...
import { PermitIssuanceDeterminateableRes } from './permitIssuanceDeterminateableRes';
import { PermitIssuanceReviewDecision } from './permitIssuanceReviewDecision';

export interface PermitIssuanceApplicationReviewRequestTaskPayload {
  determination?: PermitIssuanceDeterminateableRes;

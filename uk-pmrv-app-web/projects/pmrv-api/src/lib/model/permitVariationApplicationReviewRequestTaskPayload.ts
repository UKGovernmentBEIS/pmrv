...
import { PermitVariationDeterminateableRes } from './permitVariationDeterminateableRes';
import { PermitVariationReviewDecision } from './permitVariationReviewDecision';

export interface PermitVariationApplicationReviewRequestTaskPayload {
  determination?: PermitVariationDeterminateableRes;
